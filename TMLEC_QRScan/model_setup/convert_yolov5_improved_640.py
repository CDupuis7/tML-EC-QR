...
def create_yolov5_model():
    ...
    input_shape = (1, 3, 640, 640)  # Updated to 640x640
...
def convert_onnx_to_tflite():
    try:
        ...
        try:
            ...
            # Test inference with random input - Updated to 640x640
